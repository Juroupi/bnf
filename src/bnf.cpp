...
void printUsage(char* argv[]) {
    ...
    cout << "    random <n>       -- A random element (uniform) of size n that can be generated by the given non-terminal" << endl;
    ...
    cout << "    count <n> <r>    -- For each element of size n that can be generated by the given non-terminal, the number of times it was generated for a total of r random elements (uniform)" << endl;
